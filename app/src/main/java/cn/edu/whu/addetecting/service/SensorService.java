...
import cn.edu.whu.addetecting.R;
...
//        audioFileName = lastRecordTime.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) + "-" + "audio.pcm";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        NotificationChannel channel = new NotificationChannel("123456","ad detecting", NotificationManager.IMPORTANCE_HIGH);
